...
export default {
  ...
  mfuVision(method, data) {
    switch (method) {
      case 'records':
        return instance.get('/api/v1/mfu/records', { params: data || {} });
      case 'record':
        return instance.get(`/api/v1/mfu/records/${data && (data.id || data._id)}`);
      case 'stats':
        return instance.get('/api/v1/mfu/records/stats', { params: data || {} });
      case 'create':
        return instance.post('/api/v1/mfu/records', data || {});
      case 'update':
        return instance.put(`/api/v1/mfu/records/${data && (data.id || data._id)}`, data || {});
      case 'delete':
